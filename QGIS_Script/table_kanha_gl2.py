...
# ============================================================
aoi_layers = QgsProject.instance().mapLayersByName("kanha_grass_2")
if not aoi_layers:
    raise Exception("❌ AOI layer 'kanha_grass_2' not found in QGIS")
...
# ============================================================
layer = QgsVectorLayer("None", "gl2_kanha_table", "memory")
